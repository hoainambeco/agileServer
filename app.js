...
var hoaDonXuat = require('./routes/hoaDonXuat');
var quanLy = require('./routes/quanLy');
var positionWarehouse = require('./routes/positionWarehouse');
var app = express();
...
app.use('/HDX',hoaDonXuat);
app.use('/quanLy',quanLy);
app.use('/position',positionWarehouse);
